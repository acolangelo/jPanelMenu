...
return"fixed"===jQuery.css(elem,"position")?offset=elem.getBoundingClientRect():(offsetParent=this.offsetParent(),offset=this.offset(),jQuery.nodeName(offsetParent[0],"html")||(parentOffset=offsetParent.offset()),parentOffset.top+=jQuery.css(offsetParent[0],"borderTopWidth",!0),parentOffset.left+=jQuery.css(offsetParent[0],"borderLeftWidth",!0)),{top:offset.top-parentOffset.top-jQuery.css(elem,"marginTop",!0),left:offset.left-parentOffset.left-jQuery.css(elem,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var offsetParent=this.offsetParent||document.documentElement;offsetParent&&!jQuery.nodeName(offsetParent,"html")&&"static"===jQuery.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||document.documentElement})}}),jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top=/Y/.test(prop);jQuery.fn[method]=function(val){return jQuery.access(this,function(elem,method,val){var win=getWindow(elem);return val===undefined?win?prop in win?win[prop]:win.document.documentElement[method]:elem[method]:void(win?win.scrollTo(top?jQuery(win).scrollLeft():val,top?val:jQuery(win).scrollTop()):elem[method]=val)},method,val,arguments.length,null)}}),jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||"boolean"!=typeof margin),extra=defaultExtra||(margin===!0||value===!0?"margin":"border");return jQuery.access(this,function(elem,type,value){var doc;return jQuery.isWindow(elem)?elem.document.documentElement["client"+name]:9===elem.nodeType?(doc=elem.documentElement,Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])):value===undefined?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:undefined,chainable,null)}})}),window.jQuery=window.$=jQuery,"function"==typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return jQuery})}(window),function($){$.jPanelMenu=function(options){("undefined"==typeof options||null==options)&&(options={});var jP={options:$.extend({menu:"#menu",trigger:".menu-trigger",excludedPanelContent:"style, script",keepEventHandlers:!1,direction:"left",openPosition:"250px",animated:!0,closeOnContentClick:!0,keyboardShortcuts:[{code:27,open:!1,close:!0},{code:37,open:!1,close:!0},{code:39,open:!0,close:!0},{code:77,open:!0,close:!0}],duration:150,openDuration:options.duration||150,closeDuration:options.duration||150,easing:"ease-in-out",openEasing:options.easing||"ease-in-out",closeEasing:options.easing||"ease-in-out",before:function(){},beforeOpen:function(){},beforeClose:function(){},after:function(){},afterOpen:function(){},afterClose:function(){},beforeOn:function(){},afterOn:function(){},beforeOff:function(){},afterOff:function(){}},options),settings:{transitionsSupported:"WebkitTransition"in document.body.style||"MozTransition"in document.body.style||"msTransition"in document.body.style||"OTransition"in document.body.style||"Transition"in document.body.style,transformsSupported:"WebkitTransform"in document.body.style||"MozTransform"in document.body.style||"msTransform"in document.body.style||"OTransform"in document.body.style||"Transform"in document.body.style,cssPrefix:"",shiftFixedChildren:!1,panelPosition:"relative",positionUnits:"px"},menu:"#jPanelMenu-menu",panel:".jPanelMenu-panel",fixedChildren:[],timeouts:{},clearTimeouts:function(){clearTimeout(jP.timeouts.open),clearTimeout(jP.timeouts.afterOpen),clearTimeout(jP.timeouts.afterClose)},setPositionUnits:function(){var foundUnit=!1,allowedUnits=["%","px","em"];for(unitID in allowedUnits){var unit=allowedUnits[unitID];jP.options.openPosition.toString().substr(-unit.length)==unit&&(foundUnit=!0,jP.settings.positionUnits=unit)}foundUnit||(jP.options.openPosition=parseInt(jP.options.openPosition)+jP.settings.positionUnits)},computePositionStyle:function(open,string){var position=open?jP.options.openPosition:"0"+jP.settings.positionUnits,property={};if(jP.settings.transformsSupported){var direction=open&&"right"==jP.options.direction?"-":"",translate="translate3d("+direction+position+",0,0)",transform="transform";string?(property="",""!=jP.settings.cssPrefix&&(property=jP.settings.cssPrefix+transform+":"+translate+";"),property+=transform+":"+translate+";"):(""!=jP.settings.cssPrefix&&(property[jP.settings.cssPrefix+transform]=translate),property[transform]=translate)}else string?(property="",property=jP.options.direction+": "+position+";"):property[jP.options.direction]=position;return property},setCSSPrefix:function(){jP.settings.cssPrefix=jP.getCSSPrefix()},checkFixedChildren:function(){jP.disableTransitions();var defaultPanelStyle={position:$(jP.panel).css("position")};if(defaultPanelStyle[jP.options.direction]="auto"==$(jP.panel).css(jP.options.direction)?0:$(jP.panel).css(jP.options.direction),$(jP.panel).find("> *").each(function(){"fixed"==$(this).css("position")&&"auto"==$(this).css(jP.options.direction)&&jP.fixedChildren.push(this)}),jP.fixedChildren.length>0){var newPanelStyle={position:"relative"};newPanelStyle[jP.options.direction]="1px",jP.setPanelStyle(newPanelStyle),0==parseInt($(jP.fixedChildren[0]).offset().left)&&(jP.settings.shiftFixedChildren=!0)}jP.setPanelStyle(defaultPanelStyle)},setjPanelMenuStyles:function(){var bgColor="#fff",htmlBG=$("html").css("background-color"),bodyBG=$("body").css("background-color");bgColor="transparent"!=bodyBG&&"rgba(0, 0, 0, 0)"!=bodyBG?bodyBG:"transparent"!=htmlBG&&"rgba(0, 0, 0, 0)"!=htmlBG?htmlBG:"#fff",0==$("#jPanelMenu-style-master").length&&$("body").append('<style id="jPanelMenu-style-master">body{width:100%}.jPanelMenu,body{overflow-x:hidden}#jPanelMenu-menu{display:block;position:fixed;top:0;'+jP.options.direction+":0;height:100%;z-index:-1;overflow-x:hidden;overflow-y:scroll;-webkit-overflow-scrolling:touch}.jPanelMenu-panel{position:static;"+jP.computePositionStyle(!1,!0)+"z-index:2;width:100%;min-height:100%;background:"+bgColor+"}</style>")},setMenuState:function(open){var position=open?"open":"closed";$("body").attr("data-menu-position",position)},getMenuState:function(){return $("body").attr("data-menu-position")},menuIsOpen:function(){return"open"==jP.getMenuState()?!0:!1},setMenuStyle:function(styles){$(jP.menu).css(styles)},setPanelStyle:function(styles){$(jP.panel).css(styles)},showMenu:function(){jP.setMenuStyle({display:"block"}),jP.setMenuStyle({"z-index":"1"})},hideMenu:function(){jP.setMenuStyle({"z-index":"-1"}),jP.setMenuStyle({display:"none"})},enableTransitions:function(duration,easing){var formattedDuration=duration/1e3,formattedEasing=jP.getCSSEasingFunction(easing);jP.disableTransitions(),$("body").append('<style id="jPanelMenu-style-transitions">.jPanelMenu-panel{'+jP.settings.cssPrefix+"transition: all "+formattedDuration+"s "+formattedEasing+"; transition: all "+formattedDuration+"s "+formattedEasing+";}</style>")},disableTransitions:function(){$("#jPanelMenu-style-transitions").remove()},enableFixedTransitions:function(selector,id,duration,easing){var formattedDuration=duration/1e3,formattedEasing=jP.getCSSEasingFunction(easing);jP.disableFixedTransitions(id),$("body").append('<style id="jPanelMenu-style-fixed-'+id+'">'+selector+"{"+jP.settings.cssPrefix+"transition: all "+formattedDuration+"s "+formattedEasing+"; transition: all "+formattedDuration+"s "+formattedEasing+";}</style>")},disableFixedTransitions:function(id){$("#jPanelMenu-style-fixed-"+id).remove()},getCSSEasingFunction:function(name){switch(name){case"linear":return name;case"ease":return name;case"ease-in":return name;case"ease-out":return name;case"ease-in-out":return name;default:return"ease-in-out"}},getJSEasingFunction:function(name){switch(name){case"linear":return name;default:return"swing"}},getVendorPrefix:function(){if("result"in arguments.callee)return arguments.callee.result;var regex=/^(Moz|Webkit|Khtml|O|ms|Icab)(?=[A-Z])/,someScript=document.getElementsByTagName("script")[0];for(var prop in someScript.style)if(regex.test(prop))return arguments.callee.result=prop.match(regex)[0];return arguments.callee.result="WebkitOpacity"in someScript.style?"Webkit":"KhtmlOpacity"in someScript.style?"Khtml":""},getCSSPrefix:function(){var prefix=jP.getVendorPrefix();return""!=prefix?"-"+prefix.toLowerCase()+"-":""},openMenu:function(animated){("undefined"==typeof animated||null==animated)&&(animated=jP.options.animated),jP.clearTimeouts(),jP.options.before(),jP.options.beforeOpen(),jP.setMenuState(!0),jP.setPanelStyle({position:"relative"}),jP.showMenu();var animationChecks={none:animated?!1:!0,transitions:animated&&jP.settings.transitionsSupported?!0:!1};if(animationChecks.transitions||animationChecks.none){animationChecks.none&&jP.disableTransitions(),animationChecks.transitions&&jP.enableTransitions(jP.options.openDuration,jP.options.openEasing);var newPanelStyle=jP.computePositionStyle(!0);jP.setPanelStyle(newPanelStyle),jP.settings.shiftFixedChildren&&$(jP.fixedChildren).each(function(){var id=$(this).prop("tagName").toLowerCase()+" "+$(this).attr("class"),selector=id.replace(" ","."),id=id.replace(" ","-");animationChecks.none&&jP.disableFixedTransitions(id),animationChecks.transitions&&jP.enableFixedTransitions(selector,id,jP.options.openDuration,jP.options.openEasing);var newChildrenStyle={};newChildrenStyle[jP.options.direction]=jP.options.openPosition,$(this).css(newChildrenStyle)}),jP.timeouts.afterOpen=setTimeout(function(){jP.disableTransitions(),jP.settings.shiftFixedChildren&&$(jP.fixedChildren).each(function(){var id=$(this).prop("tagName").toLowerCase()+" "+$(this).attr("class"),id=id.replace(" ","-");jP.disableFixedTransitions(id)}),jP.options.after(),jP.options.afterOpen(),jP.initiateContentClickListeners()},jP.options.openDuration)}else{var formattedEasing=jP.getJSEasingFunction(jP.options.openEasing),animationOptions={};animationOptions[jP.options.direction]=jP.options.openPosition,$(jP.panel).stop().animate(animationOptions,jP.options.openDuration,formattedEasing,function(){jP.options.after(),jP.options.afterOpen(),jP.initiateContentClickListeners()}),jP.settings.shiftFixedChildren&&$(jP.fixedChildren).each(function(){var childrenAnimationOptions={};childrenAnimationOptions[jP.options.direction]=jP.options.openPosition,$(this).stop().animate(childrenAnimationOptions,jP.options.openDuration,formattedEasing)})}},closeMenu:function(animated){("undefined"==typeof animated||null==animated)&&(animated=jP.options.animated),jP.clearTimeouts(),jP.options.before(),jP.options.beforeClose(),jP.setMenuState(!1);var animationChecks={none:animated?!1:!0,transitions:animated&&jP.settings.transitionsSupported?!0:!1};if(animationChecks.transitions||animationChecks.none){animationChecks.none&&jP.disableTransitions(),animationChecks.transitions&&jP.enableTransitions(jP.options.closeDuration,jP.options.closeEasing);var newPanelStyle=jP.computePositionStyle();jP.setPanelStyle(newPanelStyle),jP.settings.shiftFixedChildren&&$(jP.fixedChildren).each(function(){var id=$(this).prop("tagName").toLowerCase()+" "+$(this).attr("class"),selector=id.replace(" ","."),id=id.replace(" ","-");animationChecks.none&&jP.disableFixedTransitions(id),animationChecks.transitions&&jP.enableFixedTransitions(selector,id,jP.options.closeDuration,jP.options.closeEasing);var newChildrenStyle={};newChildrenStyle[jP.options.direction]=0+jP.settings.positionUnits,$(this).css(newChildrenStyle)}),jP.timeouts.afterClose=setTimeout(function(){jP.setPanelStyle({position:jP.settings.panelPosition}),jP.disableTransitions(),jP.settings.shiftFixedChildren&&$(jP.fixedChildren).each(function(){var id=$(this).prop("tagName").toLowerCase()+" "+$(this).attr("class"),id=id.replace(" ","-");jP.disableFixedTransitions(id)}),jP.hideMenu(),jP.options.after(),jP.options.afterClose(),jP.destroyContentClickListeners()},jP.options.closeDuration)}else{var formattedEasing=jP.getJSEasingFunction(jP.options.closeEasing),animationOptions={};animationOptions[jP.options.direction]=0+jP.settings.positionUnits,$(jP.panel).stop().animate(animationOptions,jP.options.closeDuration,formattedEasing,function(){jP.setPanelStyle({position:jP.settings.panelPosition}),jP.hideMenu(),jP.options.after(),jP.options.afterClose(),jP.destroyContentClickListeners()}),jP.settings.shiftFixedChildren&&$(jP.fixedChildren).each(function(){var childrenAnimationOptions={};childrenAnimationOptions[jP.options.direction]=0+jP.settings.positionUnits,$(this).stop().animate(childrenAnimationOptions,jP.options.closeDuration,formattedEasing)})}},triggerMenu:function(animated){jP.menuIsOpen()?jP.closeMenu(animated):jP.openMenu(animated)},initiateClickListeners:function(){$(document).on("click",jP.options.trigger,function(){return jP.triggerMenu(jP.options.animated),!1})},destroyClickListeners:function(){$(document).off("click",jP.options.trigger,null)},initiateContentClickListeners:function(){return jP.options.closeOnContentClick?($(document).on("click",jP.panel,function(){jP.menuIsOpen()&&jP.closeMenu(jP.options.animated)}),void $(document).on("touchend",jP.panel,function(){jP.menuIsOpen()&&jP.closeMenu(jP.options.animated)})):!1},destroyContentClickListeners:function(){return jP.options.closeOnContentClick?($(document).off("click",jP.panel,null),void $(document).off("touchend",jP.panel,null)):!1},initiateKeyboardListeners:function(){var preventKeyListeners=["input","textarea"];$(document).on("keydown",function(e){var target=$(e.target),prevent=!1;if($.each(preventKeyListeners,function(){target.is(this.toString())&&(prevent=!0)}),prevent)return!0;for(mapping in jP.options.keyboardShortcuts)if(e.which==jP.options.keyboardShortcuts[mapping].code){var key=jP.options.keyboardShortcuts[mapping];return key.open&&key.close?jP.triggerMenu(jP.options.animated):!key.open||key.close||jP.menuIsOpen()?!key.open&&key.close&&jP.menuIsOpen()&&jP.closeMenu(jP.options.animated):jP.openMenu(jP.options.animated),!1}})},destroyKeyboardListeners:function(){$(document).off("keydown",null)},setupMarkup:function(){$("html").addClass("jPanelMenu"),$("body > *").not(jP.menu+", "+jP.options.excludedPanelContent).wrapAll('<div class="'+jP.panel.replace(".","")+'"/>'),$(jP.options.menu).clone(jP.options.keepEventHandlers).attr("id",jP.menu.replace("#","")).insertAfter("body > "+jP.panel)},resetMarkup:function(){$("html").removeClass("jPanelMenu"),$("body > "+jP.panel+" > *").unwrap(),$(jP.menu).remove()},init:function(){jP.options.beforeOn(),jP.setPositionUnits(),jP.setCSSPrefix(),jP.initiateClickListeners(),"[object Array]"===Object.prototype.toString.call(jP.options.keyboardShortcuts)&&jP.initiateKeyboardListeners(),jP.setjPanelMenuStyles(),jP.setMenuState(!1),jP.setupMarkup(),jP.setMenuStyle({width:jP.options.openPosition}),jP.settings.transformsSupported||jP.checkFixedChildren(),jP.closeMenu(!1),jP.options.afterOn()},destroy:function(){jP.options.beforeOff(),jP.closeMenu(),jP.destroyClickListeners(),"[object Array]"===Object.prototype.toString.call(jP.options.keyboardShortcuts)&&jP.destroyKeyboardListeners(),jP.resetMarkup();var childrenStyles={};childrenStyles[jP.options.direction]="auto",$(jP.fixedChildren).each(function(){$(this).css(childrenStyles)}),jP.fixedChildren=[],jP.options.afterOff()}};return{on:jP.init,off:jP.destroy,trigger:jP.triggerMenu,open:jP.openMenu,close:jP.closeMenu,isOpen:jP.menuIsOpen,menu:jP.menu,getMenu:function(){return $(jP.menu)},panel:jP.panel,getPanel:function(){return $(jP.panel)}}}}(jQuery),window.console&&console.log||!function(){for(var noop=function(){},methods=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","markTimeline","table","time","timeEnd","timeStamp","trace","warn"],length=methods.length,console=window.console={};length--;)console[methods[length]]=noop}();var jPanelMenu={};$(function(){$("pre").each(function(i,e){hljs.highlightBlock(e)}),jPanelMenu=$.jPanelMenu({menu:"header.main nav"});var jR=jRespond([{label:"small",enter:0,exit:800},{label:"large",enter:800,exit:1e4}]);jR.addFunc({breakpoint:"small",enter:function(){jPanelMenu.on(),$(document).on("click",jPanelMenu.menu+" li a",function(e){jPanelMenu.isOpen()&&"#"==$(e.target).attr("href").substring(0,1)&&jPanelMenu.close()})},exit:function(){jPanelMenu.off(),$(document).off("click",jPanelMenu.menu+" li a")}})});